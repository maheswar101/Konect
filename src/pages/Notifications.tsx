        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1 text-xs text-primary hover:text-primary-glow transition-colors disabled:opacity-50"
            >
              <Check size={14} />
              Mark all read
            </button>
      ...
      <div>
        {isLoading ? (
          ...
          notifications.map((notif, i) => {
            ...
            return (
              <button
                ...
                onDoubleClick={() => deleteNotificationMutation.mutate(notif.id)}
                ...
                title="Double-click to delete notification"
              >
          ...
          <div className="text-center py-12 px-4">
            ...
            <p className="text-sm text-muted-foreground/70">Activity from your network will appear here</p>
          </div>
        )}
      </div>
    </AppLayout>
